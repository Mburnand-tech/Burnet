...
- **`/articles/:article_id`** - Displays the details of specified article, including its comments, and an option to 'like' the article and its comments. If a user is logged in, theres an option to leave comments and delete previous comments of that user. 
